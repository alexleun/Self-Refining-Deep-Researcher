...
class Editor:
    def __init__(self, llm: LLMInterface, tokens):
        ...
        "- Write 3–5 paragraphs maximum (approx. 400–600 words)\n"
        "- Stay strictly within the scope of this section; do not write a full report\n"
        ...
        "- Maintain consistent style and tone across all sections\n"
        "- Do NOT include:\n"
        "  * Executive summaries\n"
        "  * Table of contents\n"
        "  * References section\n"
        ...
        "- Please keep it clear, professional, scoped, and accessible."
